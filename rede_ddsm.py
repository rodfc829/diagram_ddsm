"""Rede construída com a arquitetura DiaGRAM"""
...
def train_step(patches, whole, labels_patches, labels_whole):
    ...
    with tf.GradientTape() as disc_tape, tf.GradientTape() as class_tape, tf.GradientTape() as feat_ext_tape, tf.GradientTape() as ext_class_tape:
